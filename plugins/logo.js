...
await conn.send2Button(m.chat, text.trim(), 'HAI KAK MAU AKTIPIN ANTILINK ATAU MATIIN YA?KLIK DI BAWAH INI', '️々ANTILINK ON々️', '.enable antilink', '々ANTILINK OF々', '.disable antilink')
  } catch (e) {
    conn.reply(m.chat, 'Maaf, menu sedang error', m)
    throw e
  }
}
handler.help = ['antilink1']
handler.tags = ['group']
handler.command = /^(antilink1)$/i
handler.owner = false
handler.mods = false
